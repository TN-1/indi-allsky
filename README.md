...
[![APT Repository](https://img.shields.io/badge/APT%20Repo-GitHub%20Pages-blue?logo=debian&logoColor=white)](https://aaronwmorris.github.io/indi-allsky/)
...
[![Supported OS](https://img.shields.io/badge/Distributions-Debian%2012%2F13%20%7C%20Ubuntu%2024.04-informational?logo=ubuntu&logoColor=white)](https://github.com/aaronwmorris/indi-allsky/releases)
...
| Armbian                         | **Supported (`.deb`)**  | Use Bookworm/Trixie/Noble .deb packages |
...
*(Interactive terminal wizard will prompt for observatory coordinates and admin credentials).*

Visit the [APT Repository Web Portal](https://aaronwmorris.github.io/indi-allsky/) to switch between **Stable** and **Nightly** release channels.
...
1. **Download Packages**:
   Download the `.deb` release matching your distribution (Bookworm, Noble, or Trixie) and architecture (`arm64` or `amd64`) from the [GitHub Releases](https://github.com/aaronwmorris/indi-allsky/releases).
2. **Install**:
   ```bash
   sudo apt update
